...
- 当前 active 执行计划：`docs/exec-plans/active/2026-07-12-v0.2.16-open-source-release-plan.md`。
- 最近完成执行计划：`docs/exec-plans/completed/2026-07-12-macos-intel-acceptance-artifact-plan.md`
