...
- [ ] Add permanent History task deletion (2026-07-12) — Delete one explicitly confirmed supported History vNext task, its video/audio/transcript/AI artifacts, and per-task playback cache to release disk space immediately. Active processing, AI generation, cancellation, transcript save, legacy tasks, and linked storage remain ineligible. Partial filesystem deletion is an accepted and explicitly reported residual risk. ✅ Local/Windows evidence: app 256/256, browser 23/23 stable isolation, Rust 104/104 including real deletion/locked-file/junction failures, worker 231/231, server/build/docs/diff gates passed. macOS temporary-root evidence remains required before completion and plan archival. ExecPlan: `docs/exec-plans/active/2026-07-12-history-task-permanent-deletion-plan.md`.
